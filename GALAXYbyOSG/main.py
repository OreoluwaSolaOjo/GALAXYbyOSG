...
class MainWidget(RelativeLayout):
    ...
    menu_title_creator = StringProperty("b  y   O  S  G")
    ...
    def init_audio(self):
        ...
        self.sound_music1 = SoundLoader.load("audio/Sand.mp3")
        self.sound_restart = SoundLoader.load("audio/restart.wav")

        self.sound_music1.volume = 1
        self.sound_begin.volume = .25
        self.sound_galaxy.volume = .25
        self.sound_gameover_impact.volume = .7
    ...
    def update(self, dt):
        ...
        if int(self.current_y_loop) > 100:
            self.SPEED = .4
        if int(self.current_y_loop) > 300:
            self.SPEED = .6
        if int(self.current_y_loop) > 600:
            self.SPEED = .8
        if int(self.current_y_loop) > 1000:
            self.SPEED = 1
